const express=require('express');
    const { Mentor_log, Form_render, reg_mentor, sub_reg_mentors,get_all_mentees_info, get_Mentor_Id } = require('../controllers/mentor_control');
...
exports.mentor_id=router.get("/getMentorId",get_Mentor_Id)
